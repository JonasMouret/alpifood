...
from alpifoodapp.models import Restaurant, Meal, Order, OrderDetails
from alpifoodapp.serializers import RestaurantSerializer, MealSerializer, OrderSerializer
...
def driver_get_ready_orders(request):
    orders = OrderSerializer(Order.objects.filter(status=Order.READY,driver=None).order_by("-id"),many=True).data
