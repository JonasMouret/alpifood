...
from alpifoodapp import views, apis
...
urlpatterns = [
    ...
    url(r'^restaurant/customers/$', views.restaurant_customers, name='restaurant-customers'),
    url(r'^restaurant/drivers/$', views.restaurant_drivers, name='restaurant-drivers'),
